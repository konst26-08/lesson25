...
1. _«Создай GitHub Actions workflow: lint, test, build, deploy на Netlify при push в main»_
2. _«Добавь ESLint и Prettier в проект, скрипты lint и format:check»_
3. _«Напиши netlify.toml для SPA с redirect на index.html»_
